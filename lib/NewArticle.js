...
export default React.createClass({
  ...
  componentWillMount() {
    $.ajax({
      type: "GET",
      url: `http://tiny-tiny.herokuapp.com/collections/sa_tech_userdata_test2/${this.props.params.userID}`,
  ...
  onSubmitHandler(e){
    ...
    $.ajax({
      type: "POST",
      url: "http://tiny-tiny.herokuapp.com/collections/sa_tech_voices_test9",
